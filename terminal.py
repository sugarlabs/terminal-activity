...
OSK_HEIGHT = [400, 300]
TOOLBAR_TOTAL = style.GRID_CELL_SIZE + style.STANDARD_ICON_SIZE
SUBTOOLBAR_TOTAL = TOOLBAR_TOTAL + style.TOOLBOX_HORIZONTAL_PADDING
...
class TerminalActivity(activity.Activity):
    ...
    def _create_tab(self, tab_state):
        ...
        height = Gdk.Screen.height() - TOOLBAR_TOTAL
    ...
    def _fixed_resize_cb(self, *args):
        ...
        if self._is_fullscreen:
            dy = style.TOOLBOX_HORIZONTAL_PADDING
